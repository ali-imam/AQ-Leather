        ...
        <div className="md:flex justify-center gap-10">
          <div className="about-text h-fit">
            ...
            <p className="text-base sm:text-xl text-zinc-200 tracking-wide">
              Our approach at AQ Leather is tailored to empower fast-growing
              tech businesses by facilitating fundraising, product sales,
              simplifying complex concepts, and enabling effective talent
              acquisition.
            </p>
